...
import 'package:saunatonttu/auth/create_account/bloc/create_account_bloc.dart';
import 'package:saunatonttu/auth/formz/formz.dart';
import 'package:saunatonttu/auth/formz/full_name.dart';
    ...
    return BlocBuilder<CreateAccountBloc, CreateAccountState>(
      ...
      builder: (context, state) {
        return FormzTextField(
          ...
          errorText: state.fullName.pure ? null : state.fullName.error?.text,
        );
      },
    );
  }
    ...
    return BlocBuilder<CreateAccountBloc, CreateAccountState>(
      ...
      builder: (context, state) {
        return FormzTextField(
          ...
          errorText: state.username.pure ? null : state.username.error?.text,
        );
      },
    );
  }
    ...
    return BlocBuilder<CreateAccountBloc, CreateAccountState>(
      ...
      builder: (context, state) {
        return FormzTextField(
          ...
          obscureText: true,
          errorText: state.password.pure ? null : state.password.error?.text,
        );
      },
    );
  }
