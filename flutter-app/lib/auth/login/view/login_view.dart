...
import 'package:saunatonttu/auth/login/bloc/login_bloc.dart';
import 'package:saunatonttu/auth/formz/formz.dart';
import 'package:saunatonttu/auth/create_account/view/create_account_page.dart';
    ...
    return BlocBuilder<LoginBloc, LoginState>(
      ...
      builder: (context, state) {
        return FormzTextField(
          ...
          errorText:
              state.passwordInput.pure ? null : state.passwordInput.error?.text,
          obscureText: true,
        );
      },
    );
    ...
    return BlocBuilder<LoginBloc, LoginState>(
      ...
      builder: (context, state) {
        return FormzTextField(
          ...
          errorText:
              state.usernameInput.pure ? null : state.usernameInput.error?.text,
        );
      },
    );
  }
