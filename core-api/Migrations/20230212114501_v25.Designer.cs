...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SaunatonttuAPI.OpeningHours.Entity.OpeningHourOverride", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_opening_hour_override");

                    b.HasIndex("SaunaId")
                        .HasDatabaseName("ix_opening_hour_override_sauna_id");

                    b.ToTable("opening_hour_override", (string)null);
                });
            ...
            modelBuilder.Entity("SaunatonttuAPI.Picture.Entity.Picture", b =>
                {
                    ...
                    b.Property<string>("GoogleReference")
                        .HasColumnType("text")
                        .HasColumnName("google_reference");
            ...
            modelBuilder.Entity("SaunatonttuAPI.UserGroup.Entity.Group", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("SaunatonttuAPI.UserGroup.Entity.UserGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("SaunatonttuAPI.OpeningHours.Entity.OpeningHourOverride", b =>
                {
                    b.HasOne("SaunatonttuAPI.Sauna.Entity.Sauna", "Sauna")
                        .WithMany("OpeningHourOverrides")
                        .HasForeignKey("SaunaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_opening_hour_override_sauna_sauna_id");
            ...
            modelBuilder.Entity("SaunatonttuAPI.UserGroup.Entity.UserGroup", b =>
                {
                    b.HasOne("SaunatonttuAPI.UserGroup.Entity.Group", "Group")
                        .WithMany("UserGroups")
            ...
            modelBuilder.Entity("SaunatonttuAPI.Sauna.Entity.Sauna", b =>
                {
                    b.Navigation("OpeningHourOverrides");
